...
import { attachMemberQuotes } from './quotes';
...
const BRAULIO_DATA = {
  ...
  favoriteColor: 'Preto',
  favoriteRoom: 'Quarto',
} satisfies Omit<FamilyMember, 'id' | 'image' | 'quote'>;

/**
 * Membros da Família Sense — foto de grupo (esquerda → direita).
 */
export const FAMILY_MEMBERS: FamilyMember[] = attachMemberQuotes([
  {
    id: 'sense-02',
  ...
  },
  {
    id: 'vovo-clemente',
    name: 'Vovô Clemente',
    aliases: ['Clemente', 'Vovô', 'Vovo', 'Vovo Clemente', 'Avô Clemente', 'Avô', 'Chefe da família'],
    image: '/images/members/vovo-clemente.png',
    gender: 'masculino',
    role: 'chefe da família',
    generation: 1,
    hobbies: ['sentar'],
    favoriteFood: 'Leite Kowbell',
    personality: ['calmo', 'compreensivo'],
    age: 65,
    ageLabel: '+60',
    favoriteColor: 'Verde, Branco, Azul',
    favoriteRoom: 'Quintal',
  },
  {
    id: 'sense-04',
  ...
  {
    id: 'vanusa-carlota',
    name: 'Vanusa Carlota Simba Sense',
    aliases: ['Vanusa', 'Carlota', 'Vanusa Carlota', 'Vanusa Simba', 'Vanusa Sense'],
    image: '/images/members/vanusa-carlota.png',
    gender: 'feminino',
    role: 'filha',
    generation: 3,
    hobbies: ['ouvir música'],
    favoriteFood: 'Calulu de carne seca e kiza de muamba',
    personality: ['forte', 'stressada'],
    age: 32,
    favoriteColor: 'Preto e Vermelho',
    favoriteRoom: 'Quarto',
  },
  {
    id: 'sense-05',
  ...
  {
    id: 'joao-baeta-malila',
    name: 'João Baeta Malila Sense',
    aliases: ['João', 'Joao', 'Baeta', 'Malila', 'João Baeta', 'João Sense', 'Pai'],
    image: '/images/members/joao-baeta-malila.png',
    gender: 'masculino',
    role: 'pai',
    generation: 2,
    hobbies: ['trabalhar', 'na roça', 'sair com amigos'],
    favoriteFood: 'Chikwanga, funge, carnes, muamba e fúmbua',
    personality: ['estressado', 'brincalhão', 'sério'],
    age: 55,
    ageLabel: '+50',
    favoriteColor: 'Castanho, Preto, Cinzento, Branco, Azul escuro',
    favoriteRoom: 'Roça',
  },
  {
    id: 'braulio',
  ...
  },
  {
    id: 'genildo',
    name: 'Genildo',
    aliases: ['Genil', 'Nildo', 'Genildo Sense'],
  ...
  {
    id: 'geraldo',
    name: 'Geraldo de A. S. Sense',
    aliases: ['Geraldo', 'Geraldo Sense', 'Geraldo Simba', 'Geraldo de A. S.'],
    image: '/images/members/geraldo.png',
    gender: 'masculino',
    role: 'filho',
    generation: 4,
    hobbies: ['assistir televisão'],
    favoriteFood: 'Feijoada e Saca folha com feijão',
    personality: ['estressado', 'obediente', 'inteligente'],
    age: 19,
    favoriteColor: 'Preto e Branco',
    favoriteRoom: 'Sofá a assistir',
  },
  {
    id: 'jurilson-domingos',
    name: 'Jurilson Domingos Sense',
    aliases: ['Jurilson', 'Domingos', 'Jurilson Domingos', 'Jurilson Sense', 'Sobrinho'],
    image: '/images/members/jurilson-domingos.png',
    gender: 'masculino',
    role: 'sobrinho',
    generation: 7,
    hobbies: ['brincar'],
    favoriteFood: 'Chikwanga, papa e bolos',
    personality: ['brincalhão'],
    age: 6,
    ageLabel: '6 anos',
    favoriteColor: 'Azul',
    favoriteRoom: 'Família paternal',
  },
  {
    id: 'valeria-carlota',
    name: 'Valéria Carlota Domingos Sense',
    aliases: ['Valéria', 'Valeria', 'Carlota', 'Valéria Carlota', 'Valéria Sense', 'Sobrinha'],
    image: '/images/members/valeria-carlota.png',
    gender: 'feminino',
    role: 'sobrinha',
    generation: 7,
    hobbies: ['brincar'],
    favoriteFood: 'Saca folha com feijão, feijoada, muamba, frango e carnes',
    personality: ['estressada', 'simpática', 'sensível'],
    age: 3,
    ageLabel: '3 anos',
    favoriteColor: 'Sem preferência',
    favoriteRoom: 'Família paternal',
  },
]);
